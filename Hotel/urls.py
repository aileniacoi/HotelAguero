...
urlpatterns = [
    ...
    path('clientes/delete/<int:pk>/', views.ClienteModView.as_view(), name='deleteCliente'),
    ...
    path('listasprecio/add/', views.listaPrecio_edit, name='newlistasPrecio'),
#    path('listasprecio/edit/<int:pk>/', views.manage_lista, name='modlistasPrecio'),
