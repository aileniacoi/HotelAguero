...
from .models import Habitacion, Cliente, Reserva, ListaPrecio, MovimientoCaja

from django.contrib import messages
from django.shortcuts import render, get_object_or_404, redirect
from django.http import HttpResponse
from .forms import ClienteForm, HabitacionForm, ReservaForm, CajaForm
...
def reserva_edit(request, pk=None):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if reserva is None:
                 reserva.success(request, "La reserva \"{}\" fue creada.".format(updated_reserva))
            else:
